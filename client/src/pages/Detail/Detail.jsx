      ...
      <section className='page-detail__section01'>
        <div className='page-detail__section01__left'>
          ...
          <div className='page-detail__left__calendar' >
            ...
            {isAuthenticated && (
              <>
            <button style={{ cursor: 'pointer', float: 'right', padding:'1.5vw', margin:'2vw', backgroundColor:'#ffffff',color: '#000000',border:'4px solid #000000' , fontWeight:'bold', fontSize:'2vw'}} onClick={handleDateForm}>AÑADIR NUEVA FECHA</button>
            </>
            )}
          </div>
