      ...
      <section className='page-detail__section01'>
        <div className='page-detail__section01__left'>
          ...
          <div className='page-detail__left__extra'>
              <img className='page-detail__left__extraicon' src="src/assets/images/icons/o-icon.png" alt="" /><p className='page-detail__left__extratext' >Se puede asistir con niños: no</p>
              <img className='page-detail__left__extraicon' src="src/assets/images/icons/o-icon.png" alt="" /><p className='page-detail__left__extratext' >Disponible versión vegana: sí</p>
              <img className='page-detail__left__extraicon' src="src/assets/images/icons/o-icon.png" alt="" /><p className='page-detail__left__extratext' >Disponible en inglés: si, con consulta previa</p>
              <img className='page-detail__left__extraicon' src="src/assets/images/icons/o-icon.png" alt="" /><p className='page-detail__left__extratext' >Se puede asistir con mascotas: no</p>
              <img className='page-detail__left__extraicon' src="src/assets/images/icons/o-icon.png" alt="" /><p className='page-detail__left__extratext' >Pueden asistir más personas a la cata de las que compraron las entradas: no</p>
         </div>
        ...
        <section className='page-detail__section01__right'>
